	...
	return (
		<div className="bg-white dark:bg-primary-200">
			<div
				...
				<div className="flex items-start gap-x-4" id="page">
					<Button
			...
			<div className="p-5 sm:p-10 text-slate-600 dark:text-white mb-5">
			...
			<div className="flex flex-col gap-10 sm:gap-10 mb-10">
				<h1 className="text-slate-600 dark:text-white text-center text-2xl">Lorem ipsum dolor sit amet consectetur adipisicing.</h1>
				{Array(5)
					.fill(null)
					.map((_, index) => (
						<div
							...
							<div className="flex flex-col gap-10">
								<h1 className="text-3xl text-slate-600 dark:text-white text-center">
